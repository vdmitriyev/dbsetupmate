...
class DBSetupMateException(Exception):
    """Generic exception for DBSetupMateException.
...
class DBConnectionException(DBSetupMateException):
    """Raised when a connection to the database could not be established."""


class DBUserAlreadyExistsException(DBSetupMateException):
    """Raised when a database user with the given name already exists."""


class DBUserNotExistsException(DBSetupMateException):
    """Raised when a database user with the given name does not exist."""


class DatabaseAlreadyExistsException(DBSetupMateException):
    """Raised when a database with the given name already exists."""


class DatabaseNotExistsException(DBSetupMateException):
    """Raised when a database with the given name does not exist."""


class InsufficientPrivilegeException(DBSetupMateException):
    """Raised when the connected role is not allowed to perform the operation."""


class InvalidIdentifierException(DBSetupMateException):
...
class DBOperationException(DBSetupMateException):
...
EXCEPTION_BY_PGCODE: Dict[str, Type[DBSetupMateException]] = {
...
def exception_for_pgcode(pgcode: Optional[str]) -> Type[DBSetupMateException]:
    """Maps a PostgreSQL SQLSTATE to the matching dbsetupmate exception.
    ...
    Returns:
        Type[DBSetupMateException]: the exception class to raise
    """
